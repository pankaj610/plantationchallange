        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="panel-title"><i class="fa fa-clock-o fa-fw"></i><!-- react-text: 1601 --> Responsive Timeline
                            <!-- /react-text --></span></div>
                                ...
                                <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            ...
                                            <p><small class="text-muted"><i class="fa fa-clock-o"></i><!-- react-text: 1614 --> 11 hours ago via Twitter
                                                    <!-- /react-text --></small></p>
                                        </div>
